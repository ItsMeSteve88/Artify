...
const CreatePost = () =>
{
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        <h1 className="font-extrabold text-Aprimary text-[32px]">
          Create
        </h1>
        <p className="mt-2 text-Aprimary text-[16-px] ">
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='mt-10'>
          ...
          <button
            type='submit'
            className=' mt-10 font-medium rounded-md text-sm w-full sm:w-auto px-6 py-4 text-center bg-Asecondary text-Abackground hover:bg-Aaccent transition duration-300 ease-in-out'
          >
